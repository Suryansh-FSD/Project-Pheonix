    ...
    <div className="space-y-6 max-w-4xl">
      <div>
        ...
        <p className="text-xs sm:text-sm text-[#6D756F] pt-0.5">
          Specifications, input constraints, and troubleshooting guidelines for GeoSR.
        </p>
      </div>
        ...
        <div className="space-y-3 text-xs">
          <div className="p-3 rounded-xl bg-[#EAF0E3]/40 border border-[#D9DDD2] space-y-1">
            ...
            <p className="text-[#6D756F]">
              Scientific metrics like PSNR and SSIM require an aligned sub-meter aerial ground-truth reference image. For arbitrary user uploads, no such reference exists, so GeoSR honestly displays &ldquo;Reference unavailable&rdquo; rather than displaying fabricated scores.
            </p>
          </div>
